  ...
  <div class="hello">
    <div class="content">
      <div class="content__container">
        <p class="content__container__text">前端</p>
        
        <ul class="content__container__list">
          <li class="content__container__list__item">就要酷炫</li>
          <li class="content__container__list__item">很有趣</li>
          <li class="content__container__list__item">更新好快</li>
          <li class="content__container__list__item">好神！</li>
        </ul>
      </div>
    </div>
  </div>
